...
vec2 bumpCoord0 = fs_in.texcoords.xz*texScale + bumpTime*bumpSpeed;
vec2 bumpCoord1 = fs_in.texcoords.xz*texScale*2 + bumpTime*bumpSpeed*4;
vec2 bumpCoord2 = fs_in.texcoords.xz*texScale*4 + bumpTime*bumpSpeed*8;
